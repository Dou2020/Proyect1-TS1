<ul class="breadcrumb" style="margin-bottom: 5px;">
    ...
    <li>
        <a href="admin-home.php?view=provider-list"><i class="fa fa-list-ol" aria-hidden="true"></i> &nbsp; Proveedores de la tienda</a>
    </li>
</ul>
<div class="container">
	<div class="row">
            ...
            <div class="panel panel-info">
                ...
                <?php if($numeropaginas>=1): ?>
                  ...
                  <ul class="pagination">
                    ...
                    <?php else: ?>
                        <li>
                            <a href="admin-home.php?view=provider-list&pag=<?php echo $pagina-1; ?>">
                                <span aria-hidden="true">&laquo;</span>
                            </a>
                        </li>
                    <?php endif; ?>
                    ...
                    <?php
                        for($i=1; $i <= $numeropaginas; $i++ ){
                            if($pagina == $i){
                                echo '<li class="active"><a href="admin-home.php?view=provider-list&pag='.$i.'">'.$i.'</a></li>';
                            }else{
                                echo '<li><a href="admin-home.php?view=provider-list&pag='.$i.'">'.$i.'</a></li>';
                            }
                        }
                    ?>
