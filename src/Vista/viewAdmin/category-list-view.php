            ...
            <div class="panel panel-info">
                ...
                <div class="text-center">
                  <ul class="pagination">
                    ...
                    <?php else: ?>
                        <li>
                            <a href="admin-home.php?view=category-list&pag=<?php echo $pagina-1; ?>">
                                <span aria-hidden="true">&laquo;</span>
                            </a>
                        </li>
                    <?php endif; ?>
                    ...
                    <?php
                        for($i=1; $i <= $numeropaginas; $i++ ){
                            if($pagina == $i){
                                echo '<li class="active"><a href="admin-home.php?view=category-list&pag='.$i.'">'.$i.'</a></li>';
                            }else{
                                echo '<li><a href="admin-home.php?view=category-list&pag='.$i.'">'.$i.'</a></li>';
                            }
                        }
                    ?>
