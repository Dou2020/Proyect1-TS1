<ul class="breadcrumb" style="margin-bottom: 5px;">
    ...
    <li>
        <a href="admin-home.php?view=productlist"><i class="fa fa-list-ol" aria-hidden="true"></i> &nbsp; Productos en tienda</a>
    </li>
</ul>
<div class="container">
	<div class="row">
              ...
              <div class="panel-heading text-center"><h4>Productos en tienda</h4></div>
                ...
                <?php if($numeropaginas>=1): ?>
                  ...
                  <ul class="pagination">
                    ...
                    <?php else: ?>
                        <li>
                            <a href="admin-home.php?view=product-list&pag=<?php echo $pagina-1; ?>">
                                <span aria-hidden="true">&laquo;</span>
                            </a>
                        </li>
                    <?php endif; ?>
                    ...
                    <?php
                        for($i=1; $i <= $numeropaginas; $i++ ){
                            if($pagina == $i){
                                echo '<li class="active"><a href="admin-home.php?view=product-list&pag='.$i.'">'.$i.'</a></li>';
                            }else{
                                echo '<li><a href="admin-home.php?view=product-list&pag='.$i.'">'.$i.'</a></li>';
                            }
                        }
                    ?>
